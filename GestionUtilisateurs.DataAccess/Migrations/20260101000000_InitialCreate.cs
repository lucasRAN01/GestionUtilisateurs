...
{
    /// <summary>
    /// Migration initiale : création des tables Users, Roles, Permissions,
    /// AuditLogs et de la table de liaison RolePermissions.
    /// Générez-vous-même avec `dotnet ef migrations add` si vous préférez,
    /// cette migration est fournie pour fonctionner immédiatement.
    /// </summary>
